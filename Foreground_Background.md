...
Toda os elementos que são responsáveis pela a interação com o usuário e que componham a interface, incluindo: elementos de navegação, apresentação de conteúdo e animação. É dito estar em foreground.
